...
void printPlayerStatus(void)// 플레이어 상태 출력 
{
	int i;
...
int getAlivePlayer(void)//생존 인원 출력 
{
	int i;
	int cnt=0;
	for(i=0;i<N_PLAYER;i++)
